...
import {
  MOCK_MENSAGENS_RAPIDAS,
  type MensagemRapida,
} from "@/app/(auth)/chat/mock-mensagens-rapidas"

export default function MensagensRapidasPage() {
  const [mensagens, setMensagens] = useState<MensagemRapida[]>(MOCK_MENSAGENS_RAPIDAS)
  ...
  function abrirEditar(msg: MensagemRapida) {
