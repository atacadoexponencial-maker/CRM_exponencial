...
type Etiqueta = { id: string; nome: string; cor: string; conversas: number }
...
const MOCK_INICIAL: Etiqueta[] = [
  { id: "1", nome: "Novo cliente", cor: "#3b82f6", conversas: 5 },
  { id: "2", nome: "Recompra", cor: "#10b981", conversas: 7 },
  { id: "3", nome: "VIP", cor: "#f59e0b", conversas: 5 },
]
...
export default function EtiquetasPage() {
  const [etiquetas, setEtiquetas] = useState<Etiqueta[]>(MOCK_INICIAL)
  ...
  function abrirEditar(etiqueta: Etiqueta) {
